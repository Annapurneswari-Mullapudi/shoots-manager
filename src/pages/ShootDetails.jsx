...
//       {/* Title */}
//       <h3 className="title">{shoot.name} ({shoot.type})</h3>
...
//         <div key={i}>
//           <h4 className="locationNames">Location {i + 1} : ({loc.name})</h4>
//           <p className="Tasks">Tasks :</p>

//           {loc.tasks.map((task, j) => (
//             <Task
//                 key={task.title}
//                 task={task}
//                 shootId={shoot.id}
...
// function Task({ task, shootId, locationName }) {
...
//   // ✅ Completed by name (PERSISTENT)
//   const [completedBy, setCompletedBy] = useState(
//     localStorage.getItem(`shoot-${shoot.id}-completedBy`) || ""
//   );

//   // ✅ Check if ALL tasks in ALL locations are completed
//   const isShootCompleted = () => {
...
//           value={completedBy}
//           disabled={!isShootCompleted()}
//           onChange={(e) => setCompletedBy(e.target.value)}
//         />

//         <button
//           disabled={!isShootCompleted() || !completedBy}
//           onClick={() => {
...
//   // ✅ RESET name if shoot becomes incomplete
//   useEffect(() => {
//     if (!isShootCompleted()) {
//       setCompletedBy("");
...
//         <button
//           disabled={!isShootCompleted() || !completedBy.trim()}
//           onClick={() => {
